...
export const projects = [
  {
    name: 'B-Fit',
    description:
      'A personal project dedicated to fitness, built implementing API calls, authentication and full CRUD and using technologies such as React, Next.js, RapidAPI, Firebase and Tailwind.',
    imageUrl:
